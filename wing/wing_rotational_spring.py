...
# BOUNDARY CONDITIONS: ROTATIONAL SPRING
TAG_RIB0_CURVE = 45
...
BCS = [bc_u]
k_theta = fem.Constant(DOMAIN, 1E6)
ROTATIONAL_SPRING_COMPONENTS = [1]
...
for comp_idx in ROTATIONAL_SPRING_COMPONENTS:
    a_int += k_theta * theta[comp_idx] * theta_[comp_idx] * ds(TAG_RIB0_CURVE)
...
vprint()
vprint(f"{ux_max:.6e} {uy_max:.6e} {uz_max:.6e} {tx_max:.6e} {ty_max:.6e} {tz_max:.6e}")
vprint("="*60)
