...
# BOUNDARY CONDITIONS: CLAMPED DISPLACEMENT + PRESCRIBED MOMENT AT ROOT
TAG_RIB0_CURVE = 45
...
M_applied_val = (0.0, 5000.0, 0.0)
M_applied = fem.Constant(DOMAIN, M_applied_val)
...
L_ext      += ufl.dot(M_applied, theta_) * ds(TAG_RIB0_CURVE)
