...
msh = meshio.read("../data/CAD/wing.msh")
...
meshio.write("../data/CAD/mesh.xdmf", mesh_tri)
meshio.write("../data/CAD/mesh_facet.xdmf", mesh_line)
...
meshio.write("../data/CAD/FEMMesh.xdmf", mesh_out)
