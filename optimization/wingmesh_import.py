...
GEOMETRY_FILES = [
    ("upper",    INPUT_DIR / "skin.stp"),
    ("rib0",     INPUT_DIR / "rib0.stp"),
    ("rib750",   INPUT_DIR / "rib750.stp"),
    ("rib1500",  INPUT_DIR / "rib1500.stp"),
    ("rib2250",  INPUT_DIR / "rib2250.stp"),
    ("rib3000",  INPUT_DIR / "rib3000.stp"),
    ("mainspar", INPUT_DIR / "spar_main.stp"),
    ("tailspar", INPUT_DIR / "spar_tail.stp"),
]
...
MESH_SIZE  = 50.0
MESH_ALGO  = 6
OUTPUT_MSH = "./InputData/wingbox_.msh"
OCC_TOL    = 1e-2
BC_TOL     = 1.0
...
for name, filepath in GEOMETRY_FILES:
    tags_before = {t for (_, t) in gmsh.model.getEntities(2)}
    try:
        gmsh.model.occ.importShapes(filepath.as_posix())
